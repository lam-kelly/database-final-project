...
# for test_file in os.listdir("time_MNAR/test"):
#     test_file_name = "time_MNAR/test/" + test_file
#     actual_file = "time_MNAR/actual/time_MNAR_" + str(test_file[-5]) + "_actual.csv"
...
# with open('time_MNAR_results.json', 'w') as fp:
#     json.dump(result, fp)
