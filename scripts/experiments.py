...
for test_file in os.listdir("experimental_datasets/time_MAR/test"):
    test_file_name = "experimental_datasets/time_MAR/test/" + test_file
    actual_file = "experimental_datasets/time_MAR/actual/time_MAR_" + str(test_file[-5]) + "_actual.csv"
...
# for test_file in os.listdir("experimental_datasets/airportfrom_MNAR/test"):
#     test_file_name = "experimental_datasets/airportfrom_MNAR/test/" + test_file
#     actual_file = "experimental_datasets/airportfrom_MNAR/actual/airportfrom_MNAR_" + str(test_file[-5]) + "_actual.csv"
#     imputations = {"testfile": test_file, 'actual_file': actual_file, 'imputations': []}
...
# with open('experimental_datasets/airportfrom_MNAR_results.json', 'w') as fp:
#     json.dump(result, fp)
